    ...
    public partial class NurseRecord_SZ : Form
    {
        ...
        private void SaveNurseRecord()//保存方法
        {
            ...
            try
            {
                ...
                A_VISIT.Add("Dianjiban", cmbDianjiban.Text);
                A_VISIT.Add("TiweiGaibian", tbTiweiGaibian.Text);
                A_VISIT.Add("SQpifu", cmbSQpifu.Text);
        ...
        private void BindNurseRecord()
        {
            ...
            cmbBaonuan.Text=dt.Rows[0]["Baonuan"].ToString() ;
             ...
             cmbDianjiban.Text=dt.Rows[0]["Dianjiban"].ToString() ;
             tbTiweiGaibian.Text=dt.Rows[0]["TiweiGaibian"].ToString() ;
             cmbSQpifu.Text=dt.Rows[0]["SQpifu"].ToString() ;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawLine(Pens.Black, x + 80, y1, x + 640, y1);
            //为空画斜杠
            if (txtSSHL.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(150 + x, y + 13), new Point(170 + x, y + 2));
            ...
            e.Graphics.DrawLine(Pens.Black, x + 105, y1, x + 200, y1);
            //为空画斜杠
            if (cmbDianjiban.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(127 + x, y + 13), new Point(147 + x, y + 2));
            }
            e.Graphics.DrawString("术前皮肤评估：" + cmbSQpifu.Text, textfront, Brushes.Black, x + 220, y);
            e.Graphics.DrawLine(Pens.Black, x + 290, y1, x + 360, y1);
            //为空画斜杠
            if (cmbSQpifu.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(300 + x, y + 13), new Point(320 + x, y + 2));
            }
            e.Graphics.DrawString("WaterLow评分：" + nupBefWaterlow.Value.ToString(), textfront, Brushes.Black, x + 380, y);
            e.Graphics.DrawLine(Pens.Black, x + 460, y1, x + 520, y1);
            ...
            e.Graphics.DrawLine(Pens.Black, x + 90, y1, x + 195, y1);
            //为空画斜杠
            if (cmbSHpifu.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(130 + x, y + 13), new Point(150 + x, y + 2));
            }
            e.Graphics.DrawString("WaterLow评分：" + nupBefWaterlow.Value.ToString(), textfront, Brushes.Black, x + 210, y);
            e.Graphics.DrawLine(Pens.Black, x + 280, y1, x + 320, y1);
           

            e.Graphics.DrawString("带至复苏室血制品：" + tbFusushiXZP.Text, textfront, Brushes.Black, x + 340, y);
            e.Graphics.DrawLine(Pens.Black, x + 435, y1, x + 480, y1);
            //为空画斜杠
            if (tbFusushiXZP.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(440 + x, y + 13), new Point(450 + x, y + 2));
            }
            e.Graphics.DrawString("袋,带至病房血制品：" + this.tbBingfangXZP.Text, textfront, Brushes.Black, x + 475, y);
            e.Graphics.DrawLine(Pens.Black, x + 575, y1, x + 615, y1);
            //为空画斜杠
            if (tbFusushiXZP.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(580 + x, y + 13), new Point(595 + x, y + 2));
            }
            e.Graphics.DrawString("袋", textfront, Brushes.Black, x + 610, y);

           

            y = y + 25; y1 = y + 15;

            e.Graphics.DrawString("标本：" + txtBB.Text, textfront, Brushes.Black, x + 20, y);
            e.Graphics.DrawLine(Pens.Black, x + 50, y1, x + 80, y1);
            //为空画斜杠50
            if (txtBB.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(55 + x, y + 13), new Point(70 + x, y + 2));
            }
            e.Graphics.DrawString("件，医生签名："+ tbQmDoctor.Text, textfront, Brushes.Black, x + 75, y);
            e.Graphics.DrawLine(Pens.Black, x + 145, y1, x + 200, y1);
            e.Graphics.DrawString("术后引流：" + cmbYinliu.Text, textfront, Brushes.Black, x + 210, y);
            e.Graphics.DrawLine(Pens.Black, x + 260, y1, x + 320, y1);
            //为空画斜杠
            if (cmbYinliu.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(270 + x, y + 13), new Point(300 + x, y + 2));
            }
            e.Graphics.DrawString("植入性产品：" + tbZhiruwu.Text, textfront, Brushes.Black, x + 330, y);
            e.Graphics.DrawLine(Pens.Black, x + 390, y1, x + 670, y1);
            //为空画斜杠
            if (tbZhiruwu.Text == "")
            {
                e.Graphics.DrawLine(ptp, new Point(450 + x, y + 13), new Point(480 + x, y + 2));
            }
            y = y + 25; y1 = y + 15;
            e.Graphics.DrawString("备注：" + tbRemark.Text, textfront, Brushes.Black, x + 20, y);
            e.Graphics.DrawLine(Pens.Black, x + 50, y1, x + 670, y1);
            //为空画斜杠
            if (tbRemark.Text == "")
            {

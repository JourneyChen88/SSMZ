...
namespace main
{
    public partial class MZH_ZhengTong : Form
    {
        string MZID, PATID;
        ...
        public MZH_ZhengTong(string mzid, string patid)
        {
            PATID = patid;
            MZID = mzid;
            InitializeComponent();
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex==11)
            {
                ...
                {
                    SelectDoctor selaa = new SelectDoctor(dataGridView1, e.RowIndex, e.ColumnIndex);
                    selaa.ShowDialog();
                }
            }

...
namespace main.EmrWebReference {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ISsmzServiceHttpBinding", Namespace="http://service.emr.simlink.com")]
    public partial class ISsmzService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ISsmzService() {
            this.Url = global::main.Properties.Settings.Default.main_EmrWebReference_ISsmzService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("", RequestNamespace="http://service.emr.simlink.com", ResponseNamespace="http://service.emr.simlink.com", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("out", IsNullable=true)]
        public string getPatientInfo([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string in0) {
        ...
        /// <remarks/>
        public void getPatientInfoAsync(string in0) {
            this.getPatientInfoAsync(in0, null);
        }
        
        /// <remarks/>
        public void getPatientInfoAsync(string in0, object userState) {
            ...
            this.InvokeAsync("getPatientInfo", new object[] {
                        in0}, this.getPatientInfoOperationCompleted, userState);
        }

    ...
    public partial class Fmzystj : Form
    {
        ...
        private void Bind_dataGridView1Cell0()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                DataTable dt2 = apro.GetYSMZLbyTime(SumAll, date1, date2, ysName);
        ...
        private void document_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("麻醉医生工作统计报表", new Font("新宋体", 16, FontStyle.Bold), Brushes.Black, new Point(250, 50));
            ...
            e.Graphics.DrawString("医生名称", dgvFront, Brushes.Black, new Point(x1 + 1, y1 + 3));
            ...
            e.Graphics.DrawString("工作系数", dgvFront, Brushes.Black, new Point(x1 + 451, y1 + 3));

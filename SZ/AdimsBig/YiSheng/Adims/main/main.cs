...
namespace main
{
    public partial class main : Form, IMessageFilter
    {
        ...
        private void main_Load(object sender, EventArgs e)
        {
            ...
            if (jurisdiction.Contains("3")) szxxToolStripMenuItem.Visible = true;
            if (jurisdiction.Contains("4")) ypglToolStripMenuItem.Visible = true;
            if (jurisdiction.Contains("5")) ygxxToolStripMenuItem.Visible = true;
        ...
        {
            PAIBAN_SGShuRu formpaiban = new PAIBAN_SGShuRu();

...
namespace main
{
    public sealed class DSerialPort : SerialPort
    {
        ...
        public int ReadBuffer(int mzjldid,int type)
        {
        ...
        public void ShowBasicSubRecord(dri_phdb driSR, int mzjldid,int type)
        {
            ...
            if (dal.selectJianCeData(now,mzjldid,type).Rows.Count == 0)
            {
                ...
                {
                    if (type == 0)
                        fa = dal.insertJianCeDataMZJLD(mzjldid, soo18, soo19, soo20, soo14, soo1, soo1, soo5, soo6, so16, now);
                    if (type == 1)
                ...
                {
                    if (type == 0)
                        fa = dal.insertJianCeDataMZJLD(mzjldid, soo2, soo3, soo4, soo14, soo1, soo1, soo5, soo6, so16, now);
                    if (type == 1)

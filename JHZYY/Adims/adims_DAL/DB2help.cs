   ...
   public class DB2help//emr数据
    {
       ...
       //string strConn = "Provider=OraOLEDB.Oracle.1;Database=dbserver;Hostname=192.168.18.19;Protocol=TCPIP;Port=50000; Uid=erm;Pwd=emr";
        //string strConn = "Data Source=dbserver;Password=erm;User ID=erm;";
       public static string strConn = "Data Source=dbserver;Password=emr;User ID=emr;";
       public DataTable GetDataTable(string sql)
       {
        ...
        public DataTable GetemrbyPatid(string patid)
        {
            string sql = "select * from v_operation_emrs where zhuyuanhao='" + patid + "'";
            return this.GetDataTable(sql);
        }

...
{
    public partial class FHSTJ : Form
    {
        ...
        private void FHSTJ_Load(object sender, EventArgs e)
        {
        ...
        private void Bind_dataGridView1Cell0()
        {
            ...
            DataTable dt = _DataDicDal.GetAll_hushi();//护士
            ...
            if (SumAll != 0)
            {
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    DataTable dt2 = _OperStatisticsDal.GetHSMZLbyTime(SumAll, date1, date2, ysName);
        ...
        private void document_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("工作时间(分)", dgvFront, Brushes.Black, new Point(x1 + 101, y1 + 3));
            ...
            e.Graphics.DrawString("器械护士", dgvFront, Brushes.Black, new Point(x1 + 301, y1 + 3));
            e.Graphics.DrawLine(Pens.Black, new Point(x1 + 400, y1), new Point(x1 + 400, y1 + 30));
            e.Graphics.DrawString("巡回护士", dgvFront, Brushes.Black, new Point(x1 + 401, y1 + 3));

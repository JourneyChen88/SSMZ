...
{
    public partial class SSYSTJ : Form
    {
        ...
        /// <param name="e"></param>
        private void SSYSTJ_Load(object sender, EventArgs e)
        {
        ...
        private void Bind_dataGridView1Cell0()
        {
            ...
            DataTable dt = _DataDicDal.GetAllSSYS();//手术医生
            ...
            if (SumAll != 0)
            {
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    DataTable dt2 = _OperStatisticsDal.GetSSYSbyTime(SumAll, date1, date2, ysName);
        ...
        private void document_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("手术医生", dgvFront, Brushes.Black, new Point(x1 + 1, y1 + 3));
            e.Graphics.DrawLine(Pens.Black, new Point(x1 + 100, y1), new Point(x1 + 100, y1 + 30));
            e.Graphics.DrawString("手术时间(分)", dgvFront, Brushes.Black, new Point(x1 + 101, y1 + 3));
            ...
            e.Graphics.DrawString("主刀台数", dgvFront, Brushes.Black, new Point(x1 + 301, y1 + 3));
            e.Graphics.DrawLine(Pens.Black, new Point(x1 + 400, y1), new Point(x1 + 400, y1 + 30));
            e.Graphics.DrawString("助理台数", dgvFront, Brushes.Black, new Point(x1 + 401, y1 + 3));

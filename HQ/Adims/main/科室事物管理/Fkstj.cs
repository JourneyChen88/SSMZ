...
namespace main.科室事物管理
{
    public partial class Fkstj : Form
    {
        ...
        private void Bind_dataGridView1Cell0()//绑定统计出来的数据
        {
            ...
            DataTable dt = _OperStatisticsDal.GetYSMZLbyOroom(date1, date2);
            if (dt.Rows.Count == 0)
            {
        ...
        private void document_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("各科室工作统计报表", new Font("新宋体", 16, FontStyle.Bold), Brushes.Black, new Point(270, 50));

    ...
    public partial class FSSJTJ : Form
    {
        ...
        private void Bind_dataGridView1Cell0()//绑定统计出来的数据
        {
            ...
            else
            {
                ...
                DataTable dt2 = _OperStatisticsDal.GetYSMZLbyOroom( date1, date2);
        ...
        private void document_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("手术间使用情况统计报表", new Font("新宋体", 16, FontStyle.Bold), Brushes.Black, new Point(270, 50));

...
namespace main
{
    public partial class Select_lifhsqk : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        adims_Utility.LineBox UC;
        public Select_lifhsqk(adims_Utility.LineBox o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_lifhsqk_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllLKHFSQK();

...
namespace main
{
    public partial class Select_MZCC : Form
    {
        DataDicDal _DataDicDal = new DataDicDal();
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        UserControl UC;
        public Select_MZCC(UserControl o)
        {
            UC = o;
            InitializeComponent();
        }
       
        private void Select_MZCC_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = _DataDicDal.GetAllMZCC();

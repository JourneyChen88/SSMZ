...
namespace main
{
    public partial class Select_QYZZ : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        UserControl UC;
        public Select_QYZZ(UserControl o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_MZPM_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllQYZZ();

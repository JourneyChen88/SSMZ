...
namespace main
{
    public partial class SelectShoushu : Form
    {
        ...
        UserControl u;
        string patid;
        public SelectShoushu(UserControl o, string pid)
        {
            u = o;
            patid = pid;
            InitializeComponent();
        }
        public SelectShoushu(UserControl o)
        {
            u = o;
            InitializeComponent();
        }
        ...
        {
            DataTable dt = _DataDicDal.GetOperationNameByPinyin("");
        ...
        {
            DataTable dt = _DataDicDal.GetOperationNameByPinyin(tbName.Text);
            dgvShoushu.DataSource = dt.DefaultView;
        }
        ...
        private void tbName_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Space || e.KeyCode == Keys.Enter)
            {
                ...
                bool flag = adims_Utility.TextValueLimit.PingHost(IPaddress, 1000);
                if (flag == false)

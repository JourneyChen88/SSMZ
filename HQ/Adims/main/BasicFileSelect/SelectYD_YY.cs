...
namespace main
{
    public partial class SelectYD_YY : Form
    {
        adims_DAL.Dics.DataDicDal _DataDicDal = new adims_DAL.Dics.DataDicDal();
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        TextBox UC;
        public SelectYD_YY(TextBox o)
        {
            UC = o;
            InitializeComponent();
        }

        private void SelectYD_YY_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = _DataDicDal.GetYoudaoYao();

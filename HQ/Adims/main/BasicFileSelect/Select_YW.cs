...
namespace main
{
    public partial class Select_YW : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        UserControl UC;
        public Select_YW(UserControl o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_YW_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllYW();

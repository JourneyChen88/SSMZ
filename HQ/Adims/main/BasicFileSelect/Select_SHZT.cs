...
namespace main
{
    public partial class Select_SHZT : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        UserControl UC;
        public Select_SHZT(UserControl o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_SHZT_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllSHZT();

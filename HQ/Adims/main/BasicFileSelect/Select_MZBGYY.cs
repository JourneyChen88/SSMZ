...
namespace main
{
    public partial class Select_MZBGYY : Form
    {
         adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        TextBox UC;
        public Select_MZBGYY(TextBox o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_MZBGYY_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllYD_MZBGYY();

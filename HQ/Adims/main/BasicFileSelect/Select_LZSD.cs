...
namespace main
{
    public partial class Select_LZSD : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        TextBox UC;
        public Select_LZSD(TextBox o)
        {
            UC = o;
            InitializeComponent();
        }
        private void Select_LZSD_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllYD_LZSD();

...
namespace main
{
    public partial class Select_CSQK : Form
    {
        adims_DAL.AdimsProvider DAL = new adims_DAL.AdimsProvider();
        UserControl UC;
        public Select_CSQK(UserControl o)
        {
            UC = o;
            InitializeComponent();
        }

        private void Select_CSQK_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DAL.GetAllCSQK();

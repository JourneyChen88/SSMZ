    ...
    public partial class addSzsj : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                DataTable dt = _SzsjListDal.GetSzsjListByName(s.Name);
                //int szid = Convert.ToInt32(dt.Rows[0][0].ToString());
                string szid = "";
                if (dt.Rows.Count > 0)
                {
                ...
                int i = _YongyaoListDal.InsertIntoSZSJ(MZID, textBox1.Text, DateTime.Now, type, szid);
                if (i > 0)
                {                   
                    datagridBind(); 
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count == 1)
            {
                if (MessageBox.Show("确定删除?", "提示", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    int j = _YongyaoListDal.deleteSZSJ(ID, type);
                    if (j > 0)
                    {
                        datagridBind();                        
                    }
        ...
        {
            datagridBind();
            DataTable DT1= _SzsjListDal.GetSzsjListDistinct();
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt= _SzsjListDal.GetSzsjListByType(cmbType.Text.Trim());               
        ...
        private void tbPinyin_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                DataTable dt = _SzsjListDal.GetSzsjListBySuoxie(tbPinyin.Text.Trim());
                listBox1.Items.Clear();

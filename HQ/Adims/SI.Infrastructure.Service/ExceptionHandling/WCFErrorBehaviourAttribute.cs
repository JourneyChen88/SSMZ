...
{
    public class WCFErrorBehaviourAttribute : Attribute, IServiceBehavior
    {
        ...
        /// </summary>
        /// <param name="errorHandlerType">aaa</param>
        public WCFErrorBehaviourAttribute(Type errorHandlerType)
        {
        ...
        /// </summary>
        /// <param name="description">bbb</param>
        /// <param name="serviceHostBase">ccc</param>
